...
AUDIO_PATHS = {
    ...
    'eat': os.path.join(os.getcwd(), 'resources/audios/eat.wav'),
    'powerup': os.path.join(os.getcwd(), 'resources/audios/powerup.wav')
}
...
IMAGE_PATHS = {
    ...
    'quit': [os.path.join(os.getcwd(), 'resources/images/错误.svg')],
    'cloud': os.path.join(os.getcwd(), 'resources/images/cloud.svg'),
    'food': os.path.join(os.getcwd(), 'resources/images/food.svg'),
    'dino': [
...
FONT_PATHS = {
    ...
    'simhei': os.path.join(os.getcwd(),'resources/fonts/simhei.ttf')
}
